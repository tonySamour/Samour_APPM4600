...
def driver():
    ...
    # All three methods with starting point (1,1)
    t = time.time()
    for j in range(50):
...
# All three methods with starting point (1,-1)
    ...
    t = time.time()
    for j in range(20):
      [xstar,ier,its] = Broyden(x0_1, tol,Nmax)     
    elapsed = time.time()-t
    print(xstar)
    print('Broyden: the error message reads:',ier)
    print('Broyden: took this many seconds:',elapsed/20)
    ...
    # All three methods with starting point (0,0)
    t = time.time()
    for j in range(50):
    ...
    t = time.time()
    for j in range(20):
      [xstar,ier,its] =  LazyNewton(x0_2,tol,Nmax)
    elapsed = time.time()-t
    print(xstar)
    print('Lazy Newton: the error message reads:',ier)
    print('Lazy Newton: took this many seconds:',elapsed/20)
    ...
    t = time.time()
    for j in range(20):
      [xstar,ier,its] = Broyden(x0_2, tol,Nmax)     
    elapsed = time.time()-t
    print(xstar)
    print('Broyden: the error message reads:',ier)
    print('Broyden: took this many seconds:',elapsed/20)
